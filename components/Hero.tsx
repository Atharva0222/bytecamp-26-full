...
const bytecampLogo = new URL("../assets/logo/bytecamp'26 logo.png", import.meta.url).href;
        ...
        >
          ...
          <div className="flex justify-center mb-12 transform hover:scale-105 transition-transform duration-500">
            <img
              src={bytecampLogo}
              alt="ByteCamp'26"
              className="max-w-full h-24 md:h-36 lg:h-44 object-contain select-none"
              draggable={false}
            />
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm font-mono text-gray-300 mb-10">
            <div className="flex items-center gap-2 px-4 py-2 bg-zinc-900 rounded-lg border border-zinc-800">
              <Calendar className="w-4 h-4" /> March 14-15, 2026
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-zinc-900 rounded-lg border border-zinc-800">
              <MapPin className="w-4 h-4" /> Navi Mumbai, IN
            </div>
          </div>
